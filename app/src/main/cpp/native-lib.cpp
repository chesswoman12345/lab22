...
Java_com_example_jnidemo1_MainActivity_helloFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_jnidemo1_MainActivity_factorial(
        JNIEnv* env,
        jobject /* this */,
        jint n) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_jnidemo1_MainActivity_reverseString(
        JNIEnv* env,
        jobject /* this */,
        jstring javaString) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_jnidemo1_MainActivity_sumArray(
        JNIEnv* env,
        jobject /* this */,
        jintArray array) {
